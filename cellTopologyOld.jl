...
export classifyCellEigenvalueOld
export classifyCellEigenvectorOld
...
function compare(a::cellTopology.cellTopologyEigenvalue, b::cellTopologyEigenvalue)
    return a.vertexTypesEigenvalue == b.vertexTypesEigenvalue && a.vertexTypesEigenvector == b.vertexTypesEigenvector && a.DPArray == b.DPArray && a.DNArray == b.DNArray &&
            a.RPArray == b.RPArray && a.DNArray == b.DNArray && a.RPArrayVec == b.RPArrayVec && a.RNArrayVec == b.RNArrayVec
end
...
function classifyCellEigenvalueOld(M1::SMatrix{2,2,Float64}, M2::SMatrix{2,2,Float64}, M3::SMatrix{2,2,Float64},eigenvector::Bool,verbose::Bool=false)
...
function classifyCellEigenvectorOld(M1::SMatrix{2,2,Float64}, M2::SMatrix{2,2,Float64}, M3::SMatrix{2,2,Float64})
